...
void AnalogClock::setCurrentHour( const uint8_t& val )
{
	currentHour = val;
}

void AnalogClock::setCurrentMinute( const uint8_t& val )
{
	currentMinute = val;
}

void AnalogClock::setCurrentSecond( const uint8_t& val )
{
	currentSecond = val;
}
