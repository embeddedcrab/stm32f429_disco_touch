...
void HAL_RTC_MspInit(RTC_HandleTypeDef* hrtc)
{
  ...
  /* USER CODE END RTC_MspInit 0 */
	/* Configure Clock source for RTC, Handled in System Clock configurations */
//	__HAL_RCC_LSE_CONFIG( RCC_LSE_ON );	/* External Crystal not available on board */
//	__HAL_RCC_RTC_CONFIG( RCC_RTCCLKSOURCE_LSE );

	/* LSI Configuration for RTC Clock source */
