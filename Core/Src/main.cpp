...
int main(void)
{
  ...
  TaskCreationParams TaskParams = {"LED_TASK", configMINIMAL_STACK_SIZE * 2,
  ...
  MX_TouchGFX_Init();	/* Touch GFX initialization */
  ...
  LedTask__ * LedTask = new LedTask__( GPIOG , GPIO_PIN_13, &TaskParams );
  LedTask->init();
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.LSIState = RCC_LSI_ON;	/* RTC Clock */
  ...
  */
  ...
  PeriphClkInitStruct.RTCClockSelection = RCC_RTCCLKSOURCE_LSI;	/* RTC CLock */
...
/**
  ...
  * @param None
  * @retval None
  * @Note	Not initializing, Not able to enter Init mode
  */
void MX_RTC_Init(void)
{
	...
	hrtc.Init =
	{
		...
		.OutPutPolarity = RTC_OUTPUT_POLARITY_LOW,
